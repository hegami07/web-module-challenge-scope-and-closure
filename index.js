...
/*Task 1: counterMaker()
  ...
  counter1 has a closure while counter2 does not. The scope of the variables is also different since counter 1's count variable is inside a local scope, whereas counter 2's count variable is global.
  2. Which of the two uses a closure? How can you tell?
  It's counter 1 since there is another created variable (counter1) to store the data from the counterMaker function.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  counter1's code would be good for when you need to store data and still remember that stored data, whereas counter2's code would be good when you want to alter the variable yet reset it to its initial value everytime it's called/invoked.
*/
